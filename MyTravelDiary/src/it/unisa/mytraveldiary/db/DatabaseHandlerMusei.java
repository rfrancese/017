...
public class DatabaseHandlerMusei extends SQLiteOpenHelper {
	...
	private static final String TABLE_MUSEI="musei";
	private static final String TR_TIPOLOGIA= "tipologia";
	private static final String TR_NOME="nome";
	private static final String TR_CITTA="citt‡";
	...
	public void onCreate(SQLiteDatabase db) {
		String CREATE_MUSEI_TABLE="CREATE TABLE "+TABLE_MUSEI +" (" +
